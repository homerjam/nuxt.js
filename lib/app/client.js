...
function componentOption(component, key, ...args) {
  ...
  if (typeof option === 'function') {
    return option.call(this, ...args)
  }
  return option
}

function mapTransitions(app, Components, to, from) {
  const componentTransitions = component => {
    const transition = componentOption.call(app, component, 'transition', to, from) || {}
...
async function render (to, from, next) {
  ...
  // Apply transitions
  this.setTransitions(mapTransitions(this, Components, to, from))
...
async function mountApp(__app) {
  ...
  if (Components.length) {
    _app.setTransitions(mapTransitions(_app, Components, router.currentRoute))
